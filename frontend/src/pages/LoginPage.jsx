      ...
      <div className="auth-card">
        ...
        <form onSubmit={handleSubmit} noValidate>
          ...
          <div className="form-group password-field">
            ...
            <input id="login-password" type={showPassword ? 'text' : 'password'} name="password" value={formData.password} onChange={handleChange} placeholder="Enter your password" className={errors.password ? 'error-border' : ''} />
