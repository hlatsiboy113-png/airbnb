...
const Footer = () => {
  ...
  const getaways = [
    'Canmore', 'Benalmádena', 'Marbella', 'Mijas', 'Prescott', 'Scottsdale',
    'Tucson', 'Jasper', 'Mountain View', 'Devon', 'Mallorca', 'Ibiza',
    'Anaheim', 'Monterey', 'Paso Robles', 'Santa Barbara', 'Sonoma',
  ];
