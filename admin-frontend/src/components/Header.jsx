  ...
  return (
    <header className="admin-header">
      <div className="admin-header-inner">
        <Link to={isAdmin ? '/admin/dashboard' : '/host/dashboard'} className="admin-brand" aria-label="AirStay workspace">
        ...
        {isAuthenticated && <nav className="admin-nav" aria-label="Workspace navigation">
          <Link to={isAdmin ? '/admin/dashboard' : '/host/dashboard'}>Overview</Link>
          <Link to={isAdmin ? '/admin/listings' : '/host/listings'}>Listings</Link>
          <Link to={isAdmin ? '/admin/create' : '/host/create'}>Create listing</Link>
          <Link to={isAdmin ? '/admin/reservations' : '/host/reservations'}>Reservations</Link>
